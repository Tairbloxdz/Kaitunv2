    ...
    repeat 
        ...
        if UIController and ChooseTeam then
            if ChooseTeam.Visible then
                for i, v in pairs(ChooseTeam:GetChildren()) do
                    if v.Name == "Warriors" or v.Name == "Pirates" then
...
--[[ Bắt đầu giao diện Trash Hub V2 ]]--

local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/xHeptc/Kavo-UI-Library/main/source.lua"))()
local Window = Library.CreateLib("Trash Hub V2", "DarkTheme")

-- Tạo Tab Chính
local Tab = Window:NewTab("Main")
local StatusSection = Tab:NewSection("Status")

-- Các nhãn (Label) thông tin
local WorldLabel = StatusSection:NewLabel("World: Loading...")
local NameLabel = StatusSection:NewLabel("Name: Loading...")
local LevelLabel = StatusSection:NewLabel("Level: Loading...")
local FragmentsLabel = StatusSection:NewLabel("Fragments: Loading...")
local RaceLabel = StatusSection:NewLabel("Race: Loading...")
local EvoRaceLabel = StatusSection:NewLabel("Evo Race: Loading...")
local FruitLabel = StatusSection:NewLabel("Fruit: Loading...")
local FruitMasLabel = StatusSection:NewLabel("Fruit Mas: Loading...")
local AwakenLabel = StatusSection:NewLabel("Awaken: Loading...")

-- Các phần khác: Fighting, Sword, Accessory Status
local FightingSection = Tab:NewSection("Fighting Status")
local FightingLabels = {
    Godhuman = FightingSection:NewLabel("Godhuman: Loading..."),
    Superhuman = FightingSection:NewLabel("Superhuman: Loading..."),
    SharkmanKarate = FightingSection:NewLabel("SharkmanKarate: Loading..."),
    DragonTalon = FightingSection:NewLabel("DragonTalon: Loading..."),
    ElectricClaw = FightingSection:NewLabel("ElectricClaw: Loading..."),
    DeathStep = FightingSection:NewLabel("DeathStep: Loading...")
}

local SwordSection = Tab:NewSection("Sword Status")
local SwordLabels = {
    PoleV1 = SwordSection:NewLabel("Pole V1: Loading..."),
    PoleV2 = SwordSection:NewLabel("Pole V2: Loading..."),
    Rengoku = SwordSection:NewLabel("Rengoku: Loading..."),
    Shisui = SwordSection:NewLabel("Shisui: Loading..."),
    Saddi = SwordSection:NewLabel("Saddi: Loading..."),
    Wando = SwordSection:NewLabel("Wando: Loading..."),
    TrueTripleKatana = SwordSection:NewLabel("True Triple Katana: Loading...")
}

local AccessorySection = Tab:NewSection("Accessory Status")
local AccessoryLabel = AccessorySection:NewLabel("Accessory: Loading...")

-- Hàm cập nhật thông tin
local function updateAccountInfo()
    while task.wait(1) do
        -- Cập nhật thông tin chính
        WorldLabel:UpdateLabel("World: " .. tostring(game.Players.LocalPlayer.Data.World.Value or "N/A"))
        NameLabel:UpdateLabel("Name: " .. tostring(game.Players.LocalPlayer.Name or "N/A"))
        LevelLabel:UpdateLabel("Level: " .. tostring(game.Players.LocalPlayer.Data.Level.Value or "N/A"))
        FragmentsLabel:UpdateLabel("Fragments: " .. tostring(game.Players.LocalPlayer.Data.Fragments.Value or "0"))
        RaceLabel:UpdateLabel("Race: " .. tostring(game.Players.LocalPlayer.Data.Race.Value or "N/A"))
        EvoRaceLabel:UpdateLabel("Evo Race: " .. tostring(game.Players.LocalPlayer.Data.EvoRace.Value or "N/A"))
        FruitLabel:UpdateLabel("Fruit: " .. tostring(game.Players.LocalPlayer.Data.Fruit.Value or "N/A"))
        FruitMasLabel:UpdateLabel("Fruit Mas: " .. tostring(game.Players.LocalPlayer.Data.FruitMas.Value or "N/A"))
        AwakenLabel:UpdateLabel("Awaken: " .. (game.Players.LocalPlayer.Data.Awaken.Value and "✔" or "✖"))

        -- Cập nhật Fighting Status
        FightingLabels.Godhuman:UpdateLabel("Godhuman: " .. (game.Players.LocalPlayer.Data.Godhuman.Value and "✔" or "✖"))
        FightingLabels.Superhuman:UpdateLabel("Superhuman: " .. (game.Players.LocalPlayer.Data.Superhuman.Value and "✔" or "✖"))
        FightingLabels.SharkmanKarate:UpdateLabel("SharkmanKarate: " .. (game.Players.LocalPlayer.Data.SharkmanKarate.Value and "✔" or "✖"))
        FightingLabels.DragonTalon:UpdateLabel("DragonTalon: " .. (game.Players.LocalPlayer.Data.DragonTalon.Value and "✔" or "✖"))
        FightingLabels.ElectricClaw:UpdateLabel("ElectricClaw: " .. (game.Players.LocalPlayer.Data.ElectricClaw.Value and "✔" or "✖"))
        FightingLabels.DeathStep:UpdateLabel("DeathStep: " .. (game.Players.LocalPlayer.Data.DeathStep.Value and "✔" or "✖"))

        -- Cập nhật Sword Status
        SwordLabels.PoleV1:UpdateLabel("Pole V1: " .. (game.Players.LocalPlayer.Data.PoleV1.Value and "✔" or "✖"))
        SwordLabels.PoleV2:UpdateLabel("Pole V2: " .. (game.Players.LocalPlayer.Data.PoleV2.Value and "✔" or "✖"))
        SwordLabels.Rengoku:UpdateLabel("Rengoku: " .. (game.Players.LocalPlayer.Data.Rengoku.Value and "✔" or "✖"))
        SwordLabels.Shisui:UpdateLabel("Shisui: " .. (game.Players.LocalPlayer.Data.Shisui.Value and "✔" or "✖"))
        SwordLabels.Saddi:UpdateLabel("Saddi: " .. (game.Players.LocalPlayer.Data.Saddi.Value and "✔" or "✖"))
        SwordLabels.Wando:UpdateLabel("Wando: " .. (game.Players.LocalPlayer.Data.Wando.Value and "✔" or "✖"))
        SwordLabels.TrueTripleKatana:UpdateLabel("True Triple Katana: " .. (game.Players.LocalPlayer.Data.TrueTripleKatana.Value and "✔" or "✖"))

        -- Cập nhật Accessory
        AccessoryLabel:UpdateLabel("Accessory: " .. tostring(game.Players.LocalPlayer.Data.Accessory.Value or "None"))
    end
end

-- Chạy hàm cập nhật
task.spawn(updateAccountInfo)

-- Nút đóng giao diện
Tab:NewButton("Close", "Close the UI", function()
    Library:ToggleUI()
end)
